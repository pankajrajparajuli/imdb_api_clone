...
urlpatterns = [
    ...
    path('watchlist/<int:pk>/reviews-create/', views.ReviewCreateView.as_view(), name='review-create'),
    path('watchlist/<int:pk>/reviews/', views.ReviewListView.as_view(), name='review-list'),
    path('watchlist/reviews/<int:pk>/', views.ReviewDetailView.as_view(), name='review-detail'),
    ]